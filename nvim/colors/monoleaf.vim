...
hi CursorLineNr term=bold ctermbg=234 ctermfg=7 cterm=none
...
hi ToolbarLine term=underline ctermbg=0 ctermfg=15 
hi ToolbarButton cterm=bold ctermfg=15 ctermbg=235
hi Comment cterm=italic ctermfg=245
hi Constant ctermfg=245
hi Special term=bold ctermfg=250
hi Identifier term=underline ctermfg=250
hi Statement cterm=bold ctermfg=7
hi PreProc term=underline ctermfg=248
...
hi CocFloatDividingLine ctermfg=240
